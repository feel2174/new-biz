...
const styles = {
  typography: {
    ...
    media: [
      ...
      "[&_video]:rounded-lg [&_video]:border [&_video]:my-4 [&_video]:max-w-full",
      ...
      // 임베드(iframe: 유튜브/지도 등) 반응형 — 모바일 가로 오버플로우 방지
      "[&_iframe]:w-full [&_iframe]:max-w-full [&_iframe]:aspect-video [&_iframe]:h-auto [&_iframe]:rounded-lg [&_iframe]:border [&_iframe]:my-4",
    ],
    // 구텐베르그 블록(content.rendered의 wp-block-* 클래스) 반응형 대응
    wordpress: [
      // 컬럼: 데스크탑 가로, 모바일 세로 스택
      "[&_.wp-block-columns]:flex [&_.wp-block-columns]:flex-col [&_.wp-block-columns]:gap-4 md:[&_.wp-block-columns]:flex-row",
      "[&_.wp-block-column]:min-w-0 [&_.wp-block-column]:flex-1",
      // 임베드 래퍼 및 비율 유지
      "[&_.wp-block-embed]:my-4 [&_.wp-block-embed]:max-w-full",
      "[&_.wp-block-embed__wrapper]:relative [&_.wp-block-embed__wrapper]:w-full",
      // 이미지/갤러리 오버플로우 방지
      "[&_.wp-block-image]:max-w-full [&_.wp-block-image_img]:h-auto",
      "[&_.wp-block-image.aligncenter]:mx-auto [&_.aligncenter]:mx-auto",
      "[&_.wp-block-gallery]:grid [&_.wp-block-gallery]:gap-2",
      // 버튼
      "[&_.wp-block-button__link]:inline-block [&_.wp-block-button__link]:rounded-md [&_.wp-block-button__link]:bg-primary [&_.wp-block-button__link]:px-4 [&_.wp-block-button__link]:py-2 [&_.wp-block-button__link]:text-primary-foreground [&_.wp-block-button__link]:no-underline",
      // 코드/테이블 블록 가로 스크롤
      "[&_.wp-block-table]:overflow-x-auto [&_.wp-block-code]:overflow-x-auto",
    ],
    misc: [
...
const baseTypographyStyles = [
  // 긴 단어/URL로 인한 모바일 가로 오버플로우 방지
  "break-words [&_a]:break-words [&_p]:break-words [&_h1]:break-words [&_h2]:break-words [&_h3]:break-words",
